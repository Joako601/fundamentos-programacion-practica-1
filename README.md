# 📘 Fundamentos de Algebra - Práctica 1
...
Este repositorio contiene mi solución a la práctica de **Fundamentos de Algebra**, donde implemento funciones en JavaScript para resolver problemas de álgebra básica, preparándome para trabajar con operaciones matriciales más complejas.
...
- **Ejercicio 4.2 (Promedio de un array)**: Al principio olvidé el como sumar el total
...
- **Compañeros del Grupo [B/C]** por el apoyo mutuo a Astrit Airan Cetzal Cetzal, Venus Getsemaní Semino Aleman y David Alonso Romero Medina
